...
<head>
    ...
    <link rel="stylesheet" href="../css/style_akunmahasiswa.css">
</head>
<body>
    <div class="container">
        <!-- Sidebar -->
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="tombol_aksi">
                                <a href="../admin/index_kelola_edit_mahasiswa.php"><button class="add">Edit</button></a>
                                <button class="remove">Hapus</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
                <a href="../admin/index_kelola_tambah_mahasiswa.php">
    ...
    <script src="../js/index_akunmahasiswa.js"></script>
</body>
</html>